...
import { jwkRepository } from './repository/jwk.ts';
import { passwordRepository } from './repository/password.ts';
import { sessionRepository } from './repository/session.ts';
import { type User, userRepository } from './repository/user.ts';
...
export const authService = service()
  ...
  .build((jwks, users, passwords, sessions): AuthService => {
    return {
